...
class Particle {
    ...
    splash() {
        ...
        drawGradient(this.x, h / 2 +40, this.r * 0.15, this.r * 0.13);
        fill(54, 84, 49, 30);
        ellipse(this.x, h / 2 +40, this.r * 5, this.r * 3)
        strokeWeight(5)
        line(this.x - 20, h / 2 +40, this.x + 20, h / 2 +40);
    }
}

function setup() {
    let canvas = createCanvas(w, h / 2 + 40);
    canvas.parent("ayumoment");
...
function drawGradient(x, y, r1, r2) {
    let h = 0;
    for (let r = r2; r > 0; --r) {
        r < (r2 - r1) * 50 ? fill(54, 84, 49, 255) : fill(54, 84, 49, h);
